...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active position-relative" aria-current="page" href="#"><i class="bi bi-house"></i> Início</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="src/pages/pendentes.php"><i class="bi bi-exclamation-circle"></i> Pendentes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="src/pages/concluidas.php"><i class="bi bi-check-circle"></i> Concluídas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="src/pages/arquivadas.php"><i class="bi bi-archive"></i> Arquivadas</a>
                        </li>
                        <?php
                        ...
                        ?>
                            <div class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu profile-dropdown" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="src/pages/perfil.php"><i class="bi bi-person-standing"></i> Perfil</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item" href="src/php/backend/sair.php"><i class="bi bi-box-arrow-in-left"></i> Sair</a></li>
                                </ul>
                            </div>
                        <?php
                        } else {
                        ?>
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="src/pages/login.php"><i class="bi bi-box-arrow-in-right"></i> Entrar</a>
                            </li>
                        <?php
                        }
                        ?>
                    ...
                    <div class="modal fade" id="modalEdit<?php echo $id_tarefa; ?>" tabindex="-1" aria-labelledby="modalEdit<?php echo $id_tarefa; ?>" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                            <div class="modal-content" style="background-color: #282c34;">
                                ...
                                <div class="modal-body">
                                    <div class="col-md-12">
                                        <form class="forms-sample form-editar" id="form-editar-<?php echo $id_tarefa; ?>" method="post" action="src/php/backend/proc_editar_tarefa.php">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="titulo_tarefa" class="form-label">Título da Tarefa</label>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content" style="background-color: #282c34;">
                ...
                <div class="modal-body">
                    <form class="forms-sample form-tarefa" method="post" action="src/php/backend/proc_nova_tarefa.php">
                        <div class="mb-3">
    ...
    <script src="src/assets/js/procedures.js"></script>
</body>

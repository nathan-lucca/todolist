...
<head>
    ...
    <title>Todo List | Cadastro</title>
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="login.php"><i class="bi bi-box-arrow-in-right"></i> Login</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="cadastro.php"><i class="bi bi-door-open"></i> Cadastro</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <main class="w-100 m-auto mt-3" style="max-width: 400px;">
        <h1 class="h3 mb-3 fw-normal text-center">Faça seu cadastro</h1>

        <form class="forms-sample form-login" action="../php/backend/proc_cadastro.php" method="post" autocomplete="off">
            <div class="form-group">
                <label for="nome">Nome</label><span style="color: red;"> *</span>
                <input type="nome" class="form-control" name="nome_usuario" placeholder="Insira seu nome aqui" required>
            </div>
            ...
            <div class="form-group mt-2">
                <label for="senha_arquivadas">Senha de Tarefas Arquivadas</label><span style="color: red;"> *</span>
                <input type="password" class="form-control" name="senha_arquivadas_usuario" placeholder="Insira sua senha aqui" required>
            </div>

            <button class="btn btn-primary w-100 py-2 mt-4 btn-cadastro" type="submit">Entrar</button>
            <p class="mt-3 mb-1 text-black">Já possui login? <a href="login.php">Clique Aqui.</a></p>
        </form>
